...
private:
    ...
    void initializeCheckFunctions() {
        ...
        level3ComplianceFunctions = {
            ...
            {12, [this] { event e = checkNetworkAuditStatus(); e.item_id = 12; e.tmp_IsComply = e.IsComply;  return e; }},
            {13, [this] { event e = checkNetworkAuditStatus1(); e.item_id = 13; e.tmp_IsComply = e.IsComply;  return e; }},
            {14, [this] { event e = checkRsyslogBackupStatus(); e.item_id = 14; e.tmp_IsComply = e.IsComply;  return e; }},
            {15, [this] { event e = checkUserBehaviorAuditStatus(); e.item_id = 15; e.tmp_IsComply = e.IsComply;  return e; }},
            {16, [this] { event e = checkUserIdentityAuthPolicy(); e.item_id = 16; e.tmp_IsComply = e.IsComply;  return e; }},
            {17, [this] { event e = checkLoginFailureHandlingPolicy(); e.item_id = 17; e.tmp_IsComply = e.IsComply;  return e; }},
            {18, [this] { event e = checkRemoteAuthTransmissionSecurity(); e.item_id = 18; e.tmp_IsComply = e.IsComply;  return e; }},
            {19, [this] { event e = checkMultiFactorAuthStatus(); e.item_id = 19; e.tmp_IsComply = e.IsComply;  return e; }},
            {20, [this] { event e = checkUserAccountAndPermissionAssignment(); e.item_id = 20; e.tmp_IsComply = e.IsComply;  return e; }},
            {21, [this] { event e = checkDefaultAccountStatus(); e.item_id = 21; e.tmp_IsComply = e.IsComply;  return e; }},
            {22, [this] { event e = checkStaleAndSharedAccounts(); e.item_id = 22; e.tmp_IsComply = e.IsComply;  return e; }},
            {23, [this] { event e = checkAdminLeastPrivilegeSeparation(); e.item_id = 23; e.tmp_IsComply = e.IsComply;  return e; }},
            {24, [this] { event e = checkAccessControlPolicy(); e.item_id = 24; e.tmp_IsComply = e.IsComply;  return e; }},
            {25, [this] { event e = checkAccessControlGranularity(); e.item_id = 25; e.tmp_IsComply = e.IsComply;  return e; }},
            {26, [this] { event e = checkSecurityLabelAccessControl(); e.item_id = 26; e.tmp_IsComply = e.IsComply;  return e; }},
            {27, [this] { event e = checkAuditSystemStatus(); e.item_id = 27; e.tmp_IsComply = e.IsComply;  return e; }},
            {28, [this] { event e = checkAuditRecordCompleteness(); e.item_id = 28; e.tmp_IsComply = e.IsComply;  return e; }},
            {29, [this] { event e = checkAuditLogProtection(); e.item_id = 29; e.tmp_IsComply = e.IsComply;  return e; }},
            {30, [this] { event e = checkAuditProcessProtection(); e.item_id = 30; e.tmp_IsComply = e.IsComply;  return e; }},
            {31, [this] { event e = checkMinimalInstallPrinciple(); e.item_id = 31; e.tmp_IsComply = e.IsComply;  return e; }},
            {32, [this] { event e = checkUnnecessaryServicesAndPorts(); e.item_id = 32; e.tmp_IsComply = e.IsComply;  return e; }},
            {33, [this] { event e = checkIntrusionDetectionAndAlert(); e.item_id = 33; e.tmp_IsComply = e.IsComply;  return e; }},
            {34, [this] { event e = checkMalwareProtectionMechanism(); e.item_id = 34; e.tmp_IsComply = e.IsComply;  return e; }},
            {35, [this] { event e = checkCriticalDataIntegrityProtection(); e.item_id = 35; e.tmp_IsComply = e.IsComply;  return e; }},
            {36, [this] { event e = checkStorageIntegrityProtection(); e.item_id = 36; e.tmp_IsComply = e.IsComply;  return e; }},
            {37, [this] { event e = checkTransmissionConfidentialityProtection(); e.item_id = 37; e.tmp_IsComply = e.IsComply;  return e; }},
            {38, [this] { event e = checkStorageConfidentialityProtection(); e.item_id = 38; e.tmp_IsComply = e.IsComply;  return e; }},
            {39, [this] { event e = checkLocalBackupAndRecovery(); e.item_id = 39; e.tmp_IsComply = e.IsComply;  return e; }},
            {40, [this] { event e = checkHotRedundancyAvailability(); e.item_id = 40; e.tmp_IsComply = e.IsComply;  return e; }},
            {41, [this] { event e = checkAuthDataClearBeforeRelease(); e.item_id = 41; e.tmp_IsComply = e.IsComply;  return e; }},
            {42, [this] { event e = checkSensitiveDataClearBeforeReuse(); e.item_id = 42; e.tmp_IsComply = e.IsComply;  return e; }},
            {43, [this] { event e = checkPersonalInfoMinimalCollection(); e.item_id = 43; e.tmp_IsComply = e.IsComply;  return e; }},
            {44, [this] { event e = checkUnauthorizedAccessToPersonalInfo(); e.item_id = 44; e.tmp_IsComply = e.IsComply;  return e; }},
            // 可以继续添加更多三级等保检查项
        };
