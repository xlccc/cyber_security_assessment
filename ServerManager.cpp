...
{
    utility::string_t address = _XPLATSTR("http://10.9.130.150:8081/");
...
void ServerManager::redis_get_scan(http_request request) {
    ...
    std::cout << check_redis_unauthorized("root","12341234","12341234","10.9.130.150") << std::endl;
    std::cout << check_pgsql_unauthorized("root", "12341234","postgres","12341234" ,"10.9.130.150","5432" ) << std::endl;
    request.reply(web::http::status_codes::OK, "result");
}

void ServerManager::handle_get_test(http_request request)
{
    std::string ip = "10.9.130.150";
